...
function processRequest(userId, familyInfo, relationship) {
  ...
  const GEMINI_API_URL = `https://${GCP_LOCATION}-aiplatform.googleapis.com/v1/projects/${GCP_PROJECT_ID}/locations/${GCP_LOCATION}/publishers/google/models/gemini-2.5-pro:generateContent`;
