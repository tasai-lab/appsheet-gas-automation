...
- `processAllBusinessCards` (コード)
- `pairBusinessCards` (コード)
- `extractInfoWithGemini` (コード)
- `findContactAction` (コード)
- `areOrganizationsSame` (コード)
- `generateUniqueContactId` (コード)
- `createAppSheetContact` (コード)
- `updateAppSheetContact` (コード)
- `buildAppSheetPayload` (コード)
- `callAppSheetApi` (コード)
- `deleteFile` (コード)
