...
- `doPost` (main)
- `parseRequest_` (main)
- `setIdempotencyStatus_` (main)
- `executeMainLogic_` (main)
- `findFileInDrive_` (main)
- `updateAppSheetRecord_` (main)
- `handleExecutionError_` (main)
- `resetTaskStatus` (main)
