...
function generateReportWithGemini(context) {
  ...
  // 修正日: 2025-10-18
  const url = `https://${GEMINI_CONFIG.location}-aiplatform.googleapis.com/v1/projects/${GEMINI_CONFIG.projectId}/locations/${GEMINI_CONFIG.location}/publishers/google/models/${GEMINI_CONFIG.model}:generateContent`;
