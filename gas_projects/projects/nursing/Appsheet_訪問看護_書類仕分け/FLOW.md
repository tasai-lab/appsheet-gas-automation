...
flowchart TD
    ...
    style E fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style F fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style G fill:#5f5f1e,stroke:#e2e24a,stroke-width:2px,color:#ffffff
    style H fill:#8b4500,stroke:#ffa500,stroke-width:2px,color:#ffffff
    style I fill:#5f5f1e,stroke:#e2e24a,stroke-width:2px,color:#ffffff
    style J fill:#2d4a4a,stroke:#6dd6d6,stroke-width:2px,color:#ffffff
    style K fill:#5f4c1e,stroke:#e2a84a,stroke-width:2px,color:#ffffff
    style L fill:#1e5f3a,stroke:#4ae290,stroke-width:2px,color:#ffffff
    style M fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style N fill:#1e5f3a,stroke:#4ae290,stroke-width:2px,color:#ffffff
```
...
flowchart LR
    ...
    style K fill:#1e5f3a,stroke:#4ae290,stroke-width:2px,color:#ffffff
...
flowchart TD
    ...
    style A fill:#5f4c1e,stroke:#e2a84a,stroke-width:2px,color:#ffffff
    style B fill:#5f4c1e,stroke:#e2a84a,stroke-width:2px,color:#ffffff
    style C fill:#5f5f1e,stroke:#e2e24a,stroke-width:2px,color:#ffffff
    ...
    style G fill:#1e5f3a,stroke:#4ae290,stroke-width:2px,color:#ffffff
    style H fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style I fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style J fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style K fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style L fill:#5f5f1e,stroke:#e2e24a,stroke-width:2px,color:#ffffff
    style M fill:#8b0000,stroke:#ff6b6b,stroke-width:2px,color:#ffffff
    style N fill:#5f4c1e,stroke:#e2a84a,stroke-width:2px,color:#ffffff
```
