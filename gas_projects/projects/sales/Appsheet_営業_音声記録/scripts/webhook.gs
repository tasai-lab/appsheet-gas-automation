...
function doPost(e) {
  try {
    ...
    // メイン処理を呼び出し（個別引数で渡す）
    // filePathまたはaudioFilePathを使用
    const result = processSalesAudioAnalysis(
      params.activityId,
      params.filePath || params.audioFilePath,
 ...
 * @returns {Object} - 処理結果
 */
function processSalesAudioAnalysisDirect(activityId, filePath, salespersonName, contactName, orgName) {
  Logger.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
