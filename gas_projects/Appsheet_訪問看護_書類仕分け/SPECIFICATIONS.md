...
- `clearSpecificLock` (clean)
- `clearAllProcessLocks` (clean)
...
- `doPost` (main)
- `extractMedicalInsuranceInfo` (main)
- `createMedicalInsuranceRecord` (main)
- `extractLtciInsuranceInfo` (main)
- `createLtciInsuranceRecord` (main)
- `extractSubsidyInfo` (main)
- `createSubsidyRecord` (main)
- `extractBankAccountInfo` (main)
- `createBankAccountRecord` (main)
- `extractInstructionInfo` (main)
- `createInstructionRecord` (main)
- `extractFormData` (main)
- `createNewServiceFormAndDetails` (main)
- `extractCopayInfo` (main)
- `createCopayCertificateRecord` (main)
- `parseCompositeOcrText` (main)
- `callGeminiApi` (main)
- `callAppSheetApi` (main)
- `updateDocumentStatus` (main)
- `sendProcessLogEmail` (main)
- `getPublicSubsidyMasterAsText` (main)
- `getServiceMasterAsMap` (main)
- `getPrefectureCode` (main)
- `getEndDateOrDefault` (main)
- `sendCompletionNotificationEmail` (main)
- `processProvisionForm` (main)
- `getServiceFormsFromSheet` (main)
- `clearAllProcessLocks` (reset)
- `clearSpecificLock` (reset)
