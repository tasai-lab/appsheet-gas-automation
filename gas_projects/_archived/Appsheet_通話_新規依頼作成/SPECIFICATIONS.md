...
- `doPost` (コード)
- `extractNewRequestDetailsWithGemini` (コード)
- `updateRequestDetailsWithGemini` (コード)
- `callGemini` (コード)
- `createNewRequest` (コード)
- `updateExistingRequest` (コード)
- `updateCallLogOnSuccess` (コード)
- `updateCallLogOnError` (コード)
- `callAppSheetApi` (コード)
- `generateRequestId` (コード)
